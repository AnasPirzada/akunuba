...
export default function TransactionsPage() {
  const transactions = [
    ...
    { id: 3, type: 'buy', name: 'Microsoft Corp.', amount: '+$3,890.00', date: 'Oct 30, 2024', time: '11:20 AM', status: 'completed' },
    { id: 4, type: 'buy', name: 'Amazon.com Inc.', amount: '+$5,120.00', date: 'Oct 29, 2024', time: '2:15 PM', status: 'pending' },
    { id: 5, type: 'sell', name: 'Google LLC', amount: '-$2,340.00', date: 'Oct 28, 2024', time: '9:30 AM', status: 'completed' },
    { id: 6, type: 'buy', name: 'Netflix Inc.', amount: '+$1,890.00', date: 'Oct 27, 2024', time: '4:00 PM', status: 'completed' },
  ];
          ...
          <table className='w-full'>
            ...
            <tbody>
              {transactions.map((transaction) => (
                <tr key={transaction.id} className='border-b border-fullego-border/50 last:border-0'>
                  <td className='py-4'>
